...
var LZString = {
  ...
  compress: function (uncompressed) {
    ...
    for (i = 0; i < uncompressed.length; i += 1) {
      ...
      if (
        !Object.prototype.hasOwnProperty.call(context.dictionary, context.c)
      ) {
      ...
      if (
        Object.prototype.hasOwnProperty.call(context.dictionary, context.wc)
      ) {
